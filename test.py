...
if __name__=="__main__":
    ...
    parser.add_argument('--mask_type', type=str, required=True, choices=['nn', 'heuri', 'nomask'], help='Type of Mask')
    ...
    logdir = os.path.join("logs", mask_type + exp_id)
    save_video_path = f"video/test_policy_{mask_type + exp_id}.mp4"
    ...
    env_kwargs = {"save_video_path": save_video_path, "mask_type": mask_type, 'nn_mask_path': nn_mask_path, 'device':device}
